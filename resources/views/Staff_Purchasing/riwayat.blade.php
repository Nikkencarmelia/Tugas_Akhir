...
<head>
    ...
    <style>
        ...
        .status-dikirim{background:#cce5ff;color:#004085;border:1px solid #b3d7ff;}
...
<div class="orders-header">
    <h3><i class="bi bi-clock-history"></i>Riwayat Pesanan</h3>
    <div class="orders-tabs">
        <a href="#" class="orders-tab active" data-tab="dikirim">Dikirim</a>
...
<div class="tab-content">
    <!-- Tab Dikirim -->
    <div id="dikirim" class="tab-panel active orders-container">
        ...
        <div class="order-status status-dikirim"><i class="fa-solid fa-truck"></i> Dikirim</div>
        ...
        @empty
        <p class="text-center text-muted">Belum ada pesanan dikirim.</p>
        @endforelse
    </div>

    <!-- Tab Selesai -->
    <div id="selesai" class="tab-panel orders-container">
        ...
        <div class="order-status status-selesai"><i class="fa-solid fa-check-circle"></i> Selesai</div>
    ...
    <!-- Tab Ditolak -->
    <div id="ditolak" class="tab-panel orders-container">
        @forelse($ditolak ?? [] as $order)
        @php
            $subtotal = $order['total_produk_harga'];
            $ongkir_clean = str_replace(['Rp ', '.'], ['', ''], $order['ongkir']);
            $ongkir_num = (int) $ongkir_clean;
        ...
        <div class="order-status status-ditolak"><i class="fa-solid fa-times-circle"></i> Ditolak</div>
        ...
        @empty
        <p class="text-center text-muted">Belum ada pesanan ditolak.</p>
        @endforelse
    </div>
</div>
