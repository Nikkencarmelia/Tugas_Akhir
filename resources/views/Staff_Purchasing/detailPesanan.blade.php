...
<div class="container py-5">
  ...
  <div class="detail-header">
    <h3><i class="bi bi-bag-check"></i>Detail Pesanan</h3>
  ...
  <div class="detail-card">
    ...
    <div class="product-item">
      ...
      <div class="product-details">
        ...
        <p class="small text-muted mb-1">Jumlah: {{ $item['jumlah'] }} {{ $item['deskripsi'] ?? '' }}</p>
        <p class="small harga-item mb-0">Harga: Rp {{ number_format($item['harga'], 0, ',', '.') }} / unit</p>
        <p class="small text-success fw-semibold mb-0">Subtotal: Rp {{ number_format($item['subtotal'], 0, ',', '.') }}</p>
      </div>
    </div>
    @endforeach
