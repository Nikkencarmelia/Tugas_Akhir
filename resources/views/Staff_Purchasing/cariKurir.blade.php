...
<div class="toast-container position-fixed top-0 end-0 p-4" style="z-index:9999;">
    <div id="toastCari" class="toast align-items-center text-bg-success border-0 shadow-lg" role="alert" aria-live="assertive" aria-atomic="true" style="min-width:380px;font-size:1rem;border-radius:0.75rem;">
...
<div class="orders-header">
    ...
    <div class="orders-tabs">
        <a href="#" class="orders-tab active" data-tab="pesanan-baru">Pesanan Baru <span class="badge bg-success">{{ count($pengiriman_masuk) }}</span></a>
        <a href="#" class="orders-tab" data-tab="cari-kurir">Cari Kurir lagi <span class="badge bg-success">{{ count($pengiriman_masuk) }}</span></a>
    </div>
</div>
...
<div class="tab-content">
    <!-- Tab Pesanan Baru -->
    <div class="tab-panel active orders-container" id="pesanan-baru">
        ...
        @php
            ...
            $dummy_metode = rand(0, 1) ? 'pick-up' : 'diantar';
            $metode_pengiriman = isset($order['metode_pengiriman']) ? $order['metode_pengiriman'] : $dummy_metode;
        @endphp
        ...
        <div class="order-status status-menunggu-cari-kurir"><i class="fa-solid fa-clock"></i> Menunggu Cari Kurir</div>
        ...
        <button class="btn btn-success btnCariKurir btn-sm" data-bs-toggle="modal" data-bs-target="#modalCariKurir"><i class="fa-solid fa-truck me-1"></i>Cari Kurir</button>
    ...
    <!-- Tab Cari Kurir -->
    <div class="tab-panel orders-container" id="cari-kurir">
        @foreach($pengiriman_masuk as $order)
        @php
            $subtotal = $order['total_produk_harga'];
            $ongkir_clean = str_replace(['Rp ', '.'], ['', ''], $order['ongkir']);
...
<!-- Modal Cari Kurir -->
<div class="modal fade" id="modalCariKurir" tabindex="-1" aria-labelledby="modalCariKurirLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCariKurirLabel"><i class="fa-solid fa-truck me-2"></i>Pilih Kurir Pengantaran</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label for="searchKurir" class="form-label">Cari Kurir</label>
                        <input type="text" class="form-control" id="searchKurir" placeholder="Cari nama kurir...">
                    </div>
                    <div class="col-md-3">
                        <label for="filterKendaraan" class="form-label">Kendaraan</label>
                    ...
                    <div class="col-md-3">
                        <label for="filterOnline" class="form-label">Status Online</label>
                    ...
                    <div class="col-md-3">
                        <label for="filterStatusAntar" class="form-label">Status Antar</label>
                        <select class="form-select" id="filterStatusAntar">
                            <option value="">Semua</option>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody id="kurirTableBody">
                            <tr>
                                ...
                                <td>Motor</td>
                                <td><span class="badge badge-online-aktif">Aktif</span></td>
                                <td><span class="badge badge-antar-siap">Siap</span></td>
                                <td><button class="btn btn-primary btn-sm btnPilihKurir">Pilih Kurir Pengantaran</button></td>
                            </tr>
                            <tr>
                                <td>Siti Nurhaliza</td>
                                <td>0813-4567-8901</td>
                                <td>Mobil</td>
                                <td><span class="badge badge-online-tidak-aktif">Tidak Aktif</span></td>
                                <td><span class="badge badge-antar-sedang-antar">Sedang Antar</span></td>
                                <td><button class="btn btn-primary btn-sm btnPilihKurir">Pilih Kurir Pengantaran</button></td>
                            </tr>
                            <tr>
                                <td>Budi Santoso</td>
...
const toastCari=new bootstrap.Toast(document.getElementById('toastCari'),{delay:3000});

document.querySelectorAll('.btnPilihKurir').forEach(btn=>btn.addEventListener('click',()=>toastCari.show()));
...
// Modal filters and search (dummy functionality)
document.querySelectorAll('#searchKurir, #filterKendaraan, #filterOnline, #filterStatusAntar').forEach(element => {
    element.addEventListener('input', function() {
        // Dummy filter logic - in real app, this would filter the table
