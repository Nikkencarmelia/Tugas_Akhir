...
// Hapus static route jika ada
// Route::get('/pembayaran', ...) dihapus atau dicomment karena diganti dynamic route di group 'pemesanan'
...
Route::prefix('kurir')->middleware('auth')->group(function () {
        ...
        // PENGIRIMAN MASUK (REAL)
        Route::get('/pengiriman_masuk', [PemesananController::class, 'pengirimanMasukKurir'])->name('kurir.pengiriman');
        Route::post('/terima_pengiriman/{pemesanan}', [PemesananController::class, 'kurirTerima'])->name('kurir.terima');
    Route::post('/tolak_pengiriman/{pemesanan}', [PemesananController::class, 'kurirTolak'])->name('kurir.tolak');
    Route::post('/terima_dipilih', [PemesananController::class, 'kurirTerimaDipilih'])->name('kurir.terima_dipilih');
    Route::post('/tolak_dipilih', [PemesananController::class, 'kurirTolakDipilih'])->name('kurir.tolak_dipilih');
        Route::post('/terima_semua', [PemesananController::class, 'kurirTerimaSemua'])->name('kurir.terima_semua');
        Route::post('/tolak_semua', [PemesananController::class, 'kurirTolakSemua'])->name('kurir.tolak_semua');

        // STATUS PENGIRIMAN
        Route::get('/status_pengiriman', [PemesananController::class, 'statusPengirimanKurir'])->name('kurir.status_pengiriman');
        Route::post('/kirim_sekarang/{pemesanan}', [PemesananController::class, 'kurirKirimSekarang'])->name('kurir.kirim');
        Route::post('/selesai_pengiriman/{pemesanan}', [PemesananController::class, 'kurirSelesai'])->name('kurir.selesai');

        // RIWAYAT PENGIRIMAN
        Route::get('/riwayat_pengiriman', [PemesananController::class, 'riwayatPengirimanKurir'])->name('kurir.riwayat');

        // DETAIL PENGIRIMAN
        Route::get('/detail_pengiriman/{pemesanan}', [PemesananController::class, 'detailPengirimanKurir'])->name('kurir.detail_pesanan');
    });
...
Route::group(['prefix' => 'purchasing', 'middleware' => 'auth', 'as' => 'staff_purchasing.'], function () {
